<template>
    <div class="app-container">
        ...
        <el-table :data="items" v-loading="itemLoading" element-loading-text="Loading" border fit highlight-current-row>
            ...
            <el-table-column label="负责人姓名" width="110" align="center">
                <template slot-scope="scope">
                    <span>{{scope.row.managerName}}</span>
                </template>
            </el-table-column>
            <el-table-column label="负责人手机号码" width="120" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column label="营业执照文件" width="110" align="center">
                <template slot-scope="scope">
                    <el-button v-if="scope.row.licenceFileUrl" type="text" @click="getFile(scope.row.licenceFileUrl)">查看</el-button>
                </template>
            </el-table-column>
    ...
    let personalPage = new pageInit(
        {
            data: {
                ...
                apiPrefix: '/api/expo/v1/admin/exhibitor/company'
            },
            methods: {
                getFile(fileUrl){
