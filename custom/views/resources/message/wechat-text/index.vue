<template>
    <div class="app-container">
        <div class="filter-container">
            <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" :placeholder="'open_id'"
    ...
    let page = new pageInit(
        {
            data: {
                ...
                request: {
                    queryPrefix: '/wechats',
                    queryList:{
                        url :'/users/messages/texts'
                    },
                    queryCount:{
                        url: '/users/messages/texts/count'
                    }
                }
            },
            methods: {
